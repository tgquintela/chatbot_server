$(document).ready(function () {
    ...
    function format_text(sender, text_message, typesender) {
        if(typesender==="user") {
            pos_chat = "<li class='right clearfix'>"
        }
        else {
            pos_chat = "<li class='left clearfix'>"
        }
        html_data = pos_chat + '<div class="chat-body clearfix"><strong class="primary-font">' + sender + '</strong><p>' + text_message + '</p> </div></li>';
        return html_data
    };
    ...
    var put_text = function (bot_say) {
        ...
        payload  = bot_say;
        text_message = bot_say["speechResponse"];
        Speech(text_message);
//        html_data = '<li class="left clearfix"><div class="chat-body clearfix"><strong class="primary-font">Iky</strong><p>' + bot_say["speechResponse"] + '</p> </div></li>';
        html_data = format_text('Bot', text_message, 'bot')
...
//            html_data = '<li class="right clearfix"><div class="chat-body clearfix"><strong class="primary-font">you</strong><p>' + userQuery + '</p> </div></li>';
            html_data = format_text('you', userQuery, 'user')
            $("ul.chat").append(html_data);
            send_req(userQuery);
